    ...
    return (
      <SafeAreaView style={HousingQ_styles.container}>
          ...
          <ScrollView>
            ...
            onPress={()=>this.changeMultipleColor(this.state15, this.state16, this.state17)}>
            ...
            onPress={()=>this.changeMultipleColor(this.state16, this.state15, this.state17)}>
            ...
            onPress={()=>this.changeMultipleColor(this.state17, this.state16, this.state15)}>
            ...
            onPress={()=>this.changeFourColor(this.state29, this.state30, this.state31, this.state32)}>
            ...
            onPress={()=>this.changeFourColor(this.state30, this.state29, this.state31, this.state32)}>
            ...
            onPress={()=>this.changeFourColor(this.state31, this.state30, this.state29, this.state32)}>
            ...
            onPress={()=>this.changeFourColor(this.state32, this.state30, this.state29, this.state31)}>
