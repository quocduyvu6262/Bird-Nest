...
const Roles = () => {
    const selectRoles = (selectedRole) => {
        ...
        */
        ...
        if (selectedRole === "Flamingo" || selectedRole === "Owl") {
            ...
            Axios.get("http:192.168.1.13:3000/api/nohousing/11", { //TODO: don't hardcode ID
            })
            .then((response) => {
                ...
                //if user was found in opposite table (nohousing), copy that row into corresponding table and delete opposite table's row
                    ...
                    Axios.get("http://192.168.1.13:3000/api/nohousing/:id?=11", { //TODO: don't hardcode ID
                    }).then((response) => {
        ...
        else if (selectedRole === "Parrot" || selectedRole === "Penguin" || selectedRole === "Duck") {
            //Check opposing table
            Axios.get("http://192.168.1.13:3000/api/housings/", { //TODO: don't hardcode ID
            })
            .then((response) => {
                //let userResponse = response.data;
                console.log(response);
                ...
                //if user was found in opposite table (housing), copy that row into corresponding table and delete opposite table's row
                    ...
                    Axios.get("http://192.168.1.13:3000/api/housings/:id?=11", { //TODO: don't hardcode ID
                    }).then((response) => {
                        let oldInfo = response.data;
    ...
    return (
        <SafeAreaView style={Roles_styles.container}>        
            ...
            <TouchableOpacity style={Roles_styles.flamingoButton} onPress={() => selectRoles("Flamingo")}>
                <Image style={Roles_styles.icons}
                    source={require("../assets/Flamingo-512.png")}/>
                <View style={Roles_styles.viewFlex}>
                    <Text style={Roles_styles.roleTitle}>
                        Flamingo
                    </Text>
                    <Text style={Roles_styles.roleDescription}>
                        I have housing that I will live in & need another roommate or roommates.
                    </Text>
                </View>
            </TouchableOpacity> 
            <TouchableOpacity style={Roles_styles.owlButton} onPress={() => selectRoles("Owl")}>
                <Image style={Roles_styles.icons}
                    ...
                    <View style={Roles_styles.viewFlex}>
                        ...
                        <Text style={Roles_styles.roleDescription}>
                            I have housing, am not living there, and need people to live in the space. (sublease)
                        </Text>
                    </View>
            </TouchableOpacity>  
            <TouchableOpacity style={Roles_styles.parrotButton} onPress={() => selectRoles("Parrot")}>
            <Image style={Roles_styles.icons}
                    ...
                    <View style={Roles_styles.viewFlexMore}>
                        ...
                        <Text style={Roles_styles.roleDescription}>
                            I do not have housing, and I am looking for housing that has people living there with whom I want to be roommates.
                        </Text>
                    </View>
            </TouchableOpacity>                    
            <TouchableOpacity style={Roles_styles.penguinButton} onPress={() => selectRoles("Penguin")}>
                <Image style={Roles_styles.icons}
                    ...
                    <View style={Roles_styles.viewFlex}>
                        ...
                        <Text style={Roles_styles.roleDescription}>
                            I do not have housing, and I am looking for roommates to look for housing with.
                        </Text>
                    </View> 
            </TouchableOpacity>   
            <TouchableOpacity style={Roles_styles.duckButton} onPress={() => selectRoles("Duck")}>
                <Image style={Roles_styles.icons}
                    ...
                    <View style={Roles_styles.viewFlexMore}>
                        ...
                        <Text style={Roles_styles.roleDescription}>
                            I do not have housing, and I already have friends who I want to room with (who are also looking for housing with me).
                        </Text>
                    </View> 
            </TouchableOpacity>
