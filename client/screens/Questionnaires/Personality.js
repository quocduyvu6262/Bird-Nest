        ...
        <ScrollView>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              this.props.dispatch(
                dataActions.updatePersonality(this.state15.name)
              );
            }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              this.props.dispatch(
                dataActions.updatePersonality(this.state16.name)
              );
            }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              this.props.dispatch(
                dataActions.updatePersonality(this.state17.name)
              );
            }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              this.props.dispatch(
                dataActions.updateHogwartHouse(this.state29.name)
              );
            }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              this.props.dispatch(
                dataActions.updateHogwartHouse(this.state30.name)
              );
            }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              this.props.dispatch(
                dataActions.updateHogwartHouse(this.state31.name)
              );
            }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              this.props.dispatch(
                dataActions.updateHogwartHouse(this.state32.name)
              );
            }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              this.props.dispatch(
                dataActions.updateTalkative(this.state7.name)
              );
            }}
          >
            <Text style={HousingQ_styles.buttonText}>Yes</Text>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              this.props.dispatch(
                dataActions.updateTalkative(this.state8.name)
              );
            }}
          >
            <Text style={HousingQ_styles.buttonText}>No</Text>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              this.props.dispatch(
                dataActions.updateVanillaChocolate(this.state23.name)
              );
            }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              this.props.dispatch(
                dataActions.updateVanillaChocolate(this.state24.name)
              );
            }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              this.props.dispatch(
                dataActions.updateMichaelLebron(this.state59.name)
              );
            }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              this.props.dispatch(
                dataActions.updateMichaelLebron(this.state60.name)
              );
            }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              this.props.dispatch(
                dataActions.updateCoffeeBoba(this.state11.name)
              );
            }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              this.props.dispatch(
                dataActions.updateCoffeeBoba(this.state12.name)
              );
            }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              this.props.dispatch(
                dataActions.updateBobaBubble(this.state13.name)
              );
            }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              this.props.dispatch(
                dataActions.updateBobaBubble(this.state14.name)
              );
            }}
          >
